...
In similar work, Desanctis & Gallupe (1987) further proposed descriptors which included a descriptor for the size of the group engaged in CSCW (smaller, larger), and a discriptor used to identify in general the type of task being conducted (planning, creativity, intellective, preference, cognitive, conflict, mixed motive). These elements helped describe the scale of the group undertaking CSCW as well as the complexity of the work objectives. 
